...
/// Return mime type of given file extension.
...
internal func MimeType(ext: String) -> String {
    ...
    ///
    if mimeTypes.contains(where: { $0.0 == lowercase_ext }) {
...
extension URL {
    ...
    /// Return mime type from file url.
...
extension NSString {
    ...
    /// Return mime type from file url string.
    internal func mimeType() -> String? {
        return MimeType(ext: self.pathExtension)
    }
